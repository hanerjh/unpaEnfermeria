...
<div class="wrapper" >
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active"><a href="/"><i class="fa fa-link"></i> <span>Consulta</span></a></li>
        <li><a href="/servicio"><i class="fa fa-link"></i> <span>Servicio</span></a></li>
        <li class="treeview">
  ...
  <div class="content-wrapper">
    ...
    <!-- Main content -->
    <section class="content container-fluid" id="appvue2">
